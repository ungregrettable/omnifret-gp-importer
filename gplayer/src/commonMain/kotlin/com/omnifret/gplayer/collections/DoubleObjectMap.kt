...
import com.omnifret.gplayer.core.DoubleObjectArrayTuple
import com.omnifret.gplayer.core.ObjectBooleanArrayTuple
...
public class DoubleObjectMap<TValue> :
    ...
    public constructor()
    public constructor(iterable: Iterable<com.omnifret.gplayer.core.IDoubleObjectArrayTuple<TValue>>) {
        for (it in iterable) {
            set(it.v0, it.v1)
        }
    }
